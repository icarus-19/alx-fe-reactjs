...
const UserProfile = ({ user = {} }) => {
  ...
  return (
    <div className="max-w-sm mx-auto my-20 rounded-lg shadow-lg bg-white">
      ...
      <div className="p-8">
        <h2 className="text-2xl font-bold text-gray-800 text-center mb-2">{name}</h2>
        <p className="text-gray-600 text-center mb-4">{email}</p>
        <p className="text-gray-500 text-sm text-center mb-6">{bio}</p>
        
        <div className="flex justify-between space-x-4">
          <button className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
            Message
          </button>
          <button className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded-lg transition duration-200">
            Follow
          </button>
        </div>
